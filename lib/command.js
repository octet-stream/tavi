...
SWITCHERS = [['-h', '--help', 'Display this help message'], ['-c', '--create', 'Create project with given pattern']];
...
exports.run = function() {
  ...
  if ('create' in options) {
    create(parser.resolve(options.create.toString()));
  }
  if ('help' in options) {
...
version = function() {
  return tavi.writeLine("" + tavi.VERSION);
};
